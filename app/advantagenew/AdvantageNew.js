...
class AdvantageNew extends Component {
    ...
    getBuserName(value) {
        ...
        let url2 = 'api/users/' + user + '/?userName=' + BinduserName + '&wxtoken=' + wxtoken;
    ...
    DefaultReci() {
        ...
        let wxtoken = this.state.wxtoken;
        let user = this.state.user;
        let url = 'api/users/' + user + '/?userName=' + BinduserName + '&wxtoken=' + wxtoken;
    ...
    chooseRe() {
        ...
        let url = 'api/users/?userName=' + BinduserName + '&wxtoken=' + wxtoken + '&comp=' + comp + '&rowCount=0'
